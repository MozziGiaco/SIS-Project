				...
				if (userChoice == 1)
					{
						...
						// student
						System.out
								.println("Please enter the second class and corresponding grade for the new student.");
				...
				if (userChoice == 2)
					{
						...
						System.out
								.println("Please enter the first name of the student you wish to take off the roster.");
						...
						System.out
								.println("Please enter the last name of the student you wish to take off the roster.");
