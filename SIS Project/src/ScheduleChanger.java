		...
		public static void changeSchedule()
			{
				...
				System.out.println("Here are "+s.getFirstName()+"'s classes:\nWhich class would you like to change?");
				...
				System.out.println("Which period would you like to switch Period "+response+":"+s.getClasses()[response-1].getName()+" with?");
